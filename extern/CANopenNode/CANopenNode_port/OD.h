...
********************************************************************************
    ...
    File info:
        ...
        Project File: CiA402_Master.xpd
        File Version: 1

        Created:      23.11.2020 12:00:00
        Created By:
        Modified:     11.03.2026 20:44:44
        Modified By:

    Device Info:
        Vendor Name:
        Vendor ID:
        Product Name: CiA402 Master
        Product ID:
...
typedef struct
{
    ...
    uint16_t x2000_controlword;
    int32_t x2001_targetPosition;
    int8_t x2002_modesOfOperation;
    int32_t x2003_targetVelocity;
    uint16_t x2004_statusword;
    int32_t x2005_actualPosition;
    int8_t x2006_modesOfOperationDisplay;
} OD_RAM_t;
