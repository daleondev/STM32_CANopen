...
typedef struct
{
    ...
    /* CiA 402 application objects — PDO mapping targets */
    uint16_t x2000_controlword;           /* TX to drive */
    int32_t x2001_targetPosition;         /* TX to drive */
    int8_t x2002_modesOfOperation;        /* TX to drive */
    int32_t x2003_targetVelocity;         /* TX to drive */
    uint16_t x2004_statusword;            /* RX from drive */
    int32_t x2005_actualPosition;         /* RX from drive */
    int8_t x2006_modesOfOperationDisplay; /* RX from drive */
} OD_RAM_t;
...
#define OD_ENTRY_H2000_controlword &OD->list[33]
#define OD_ENTRY_H2001_targetPosition &OD->list[34]
#define OD_ENTRY_H2002_modesOfOperation &OD->list[35]
#define OD_ENTRY_H2003_targetVelocity &OD->list[36]
#define OD_ENTRY_H2004_statusword &OD->list[37]
#define OD_ENTRY_H2005_actualPosition &OD->list[38]
#define OD_ENTRY_H2006_modesOfOperationDisplay &OD->list[39]
